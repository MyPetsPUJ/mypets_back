...
export interface InfoRelacionada extends Document{
...
const schema_relacionada: Schema = new Schema({
  ...
  horaRegresoCasa: {type: Number, required: true},
  ...
  patioExteriorJugar: {type: String, required: true},
  ...
  veterinarioGastos: {type: Number, required: true},
  ...
  conscienteResponsabilidad15años: {type: String, required: true},
