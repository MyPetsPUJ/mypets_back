...
const schema_perro = new mongoose_1.Schema({
...
schema_perro.plugin(mongoose_unique_validator_1.default);
exports.default = mongoose_1.default.model('Pero', schema_perro);
